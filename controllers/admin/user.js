export const signinPage = async (req, res) => {
  try {
    ...
    console.error(err)
    res.status(500).json({ errors: 'Get sign in page failed' })
  }
}
...
export const profilePage = async (req, res) => {
  try {
    ...
    console.error(err)
    res.status(500).json({ errors: 'Get profile page failed' })
  }
}
...
export const signupPage = async (req, res) => {
  try {
    ...
    console.error(err)
    res.status(500).json({ errors: 'Get sign up page failed' })
  }
}
...
export const reviewApplicationPage = async (req, res) => {
  try {
    ...
    console.error(err)
    res.status(500).json({ errors: 'Get review application page failed' })
  }
}
